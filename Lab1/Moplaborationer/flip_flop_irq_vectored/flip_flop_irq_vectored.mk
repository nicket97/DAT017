...
##
## Debug
ProjectName            :=flip_flop_irq_vectored
ConfigurationName      :=Debug
WorkspacePath          :=C:/Users/nicla/DAT017/Lab1/Moplaborationer
ProjectPath            :=C:/Users/nicla/DAT017/Lab1/Moplaborationer/flip_flop_irq_vectored
...
ObjectsFileList        :="flip_flop_irq_vectored.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/flip_flop_irq_vectored.elf ./Debug/flip_flop_irq_vectored.s19
	arm-none-eabi-objdump -D -S ./Debug/flip_flop_irq_vectored.elf > ./Debug/flip_flop_irq_vectored.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/nicla/DAT017/Lab1/Moplaborationer/flip_flop_irq_vectored/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
