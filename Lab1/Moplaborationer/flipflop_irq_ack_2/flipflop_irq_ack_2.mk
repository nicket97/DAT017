...
##
## Debug
ProjectName            :=flipflop_irq_ack_2
ConfigurationName      :=Debug
WorkspacePath          :=C:/Users/nicla/DAT017/Lab1/Moplaborationer
ProjectPath            :=C:/Users/nicla/DAT017/Lab1/Moplaborationer/flipflop_irq_ack_2
...
ObjectsFileList        :="flipflop_irq_ack_2.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/flipflop_irq_ack_2.elf ./Debug/flipflop_irq_ack_2.s19
	arm-none-eabi-objdump -D -S ./Debug/flipflop_irq_ack_2.elf > ./Debug/flipflop_irq_ack_2.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/nicla/DAT017/Lab1/Moplaborationer/flipflop_irq_ack_2/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
