...
##
## Debug
ProjectName            :=pong_working
ConfigurationName      :=Debug
WorkspacePath          :=C:/Users/nicla/DAT017/Lab1/Moplaborationer
ProjectPath            :=C:/Users/nicla/DAT017/Lab1/Moplaborationer/pong_working
...
ObjectsFileList        :="pong_working.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/pong_working.elf ./Debug/pong_working.s19
	arm-none-eabi-objdump -D -S ./Debug/pong_working.elf > ./Debug/pong_working.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/nicla/DAT017/Lab1/Moplaborationer/pong_working/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
