...
##
## Debug
ProjectName            :=aoutoPong
ConfigurationName      :=Debug
WorkspacePath          :=C:/Users/nicla/DAT017/Lab1/Moplaborationer
ProjectPath            :=C:/Users/nicla/DAT017/Lab1/Moplaborationer/aoutoPong
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/aoutoPong.elf ./Debug/aoutoPong.s19
	arm-none-eabi-objdump -D -S ./Debug/aoutoPong.elf > ./Debug/aoutoPong.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/nicla/DAT017/Lab1/Moplaborationer/aoutoPong/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
